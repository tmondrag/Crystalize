...

{
  ...
  if (b->verbose > 2) {
    fflush(stdout);
    printf("%d region attributes to spread.\n",regions);
    fflush(stdout);
  }
  if (regions > 0) {
    ...
    for (i = 0; i < regions; i++) {
      ...
      if ((regionlist[4 * i] >= m->xmin) && (regionlist[4 * i] <= m->xmax) &&
        ...
        if (b->verbose > 2) {
          fflush(stdout);
          printf("  Searching for triangle containing region starting point (%f,%f).\n",regionlist[4 * i],regionlist[4 * i + 1]);
          fflush(stdout);
        }
        /* Start searching from some triangle on the outer boundary. */
        searchtri.tri = m->dummytri;
        ...
        fflush(stdout);
        printf("  Region starting point (%f,%f) is outside bounds x = (%f,%f) y = (%f,%f).\n",regionlist[4 * i],regionlist[4 * i + 1],m->xmin,m->xmax,m->ymin,m->ymax);
        fflush(stdout);
      }
    }
  }
...

{
...
#ifdef TRILIBRARY
  if (!b->quiet) {
    printf("Writing %ld vertices.\n",outvertices);
  }
  /* Allocate memory for output vertices if necessary. */
  /* the check (*pointlist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output pointlist to NULL in your main() */
  /* If this evaluates to false, the output pointlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  if (*pointlist == (REAL *) NULL) {
    *pointlist = (REAL *) trimalloc((int) (outvertices * 2 * sizeof(REAL)));
  }
  /* Allocate memory for output vertex attributes if necessary. */
  /* the check (*pointattriblist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output pointattriblist to NULL in your main() */
  /* If this evaluates to false, the output pointattriblist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  /* the check (*pointmarkerlist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output pointmarkerlist to NULL in your main() */
  /* If this evaluates to false, the output pointmarkerlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...

{
...
#ifdef TRILIBRARY
  if (!b->quiet) {
    printf("Writing %ld triangles.\n",m->triangles.items);
  }
  /* Allocate memory for output triangles if necessary. */
  /* the check (*trianglelist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output trianglelist to NULL in your main() */
  /* If this evaluates to false, the output trianglelist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  /* If it produces a false negative, you likely forgot to initialize the output triangleattriblist to NULL in your main() */
  /* If this evaluates to false, the output triangleattriblist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...

{
...
#ifdef TRILIBRARY
  if (!b->quiet) {
    printf("Writing %ld segments.\n",m->subsegs.items);
  }
  /* Allocate memory for output segments if necessary. */
  /* the check (*segmentlist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output segmentlist to NULL in your main() */
  /* If this evaluates to false, the output segmentlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  /* the check (*segmentmarkerlist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output segmentmarkerlist to NULL in your main() */
  /* If this evaluates to false, the output segmentmarkerlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...

{
  ...
  /* the check (*edgelist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output edgelist to NULL in your main() */
  /* If this evaluates to false, the output edgelist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  if (*edgelist == (int *) NULL) {
    *edgelist = (int *) trimalloc((int) (m->edges * 2 * sizeof(int)));
  }
  /* Allocate memory for edge markers if necessary. */
  /* the check (*edgemarkerlist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output edgemarkerlist to NULL in your main() */
  /* If this evaluates to false, the output edgemarkerlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...

{
  ...
  /* the check (*vpointlist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output vpointlist to NULL in your main() */
  /* If this evaluates to false, the output vpointlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  /* the check (*vpointattriblist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output triangleattriblist to NULL in your main() */
  /* If this evaluates to false, the output triangleattriblist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  *vpointmarkerlist = (int *) NULL;
  ...
  /* the check (*vedgelist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output vedgelist to NULL in your main() */
  /* If this evaluates to false, the output vedgelist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
  ...
  *vedgemarkerlist = (int *) NULL;
  ...
  /* the check (*vnormlist == (REAL *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output vnormlist to NULL in your main() */
  /* If this evaluates to false, the output vnormlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...

{
  ...
  /* the check (*neighborlist == (int *) NULL) is insufficient/bad */
  /* If it produces a false negative, you likely forgot to initialize the output nighborlist to NULL in your main() */
  /* If this evaluates to false, the output neighborlist won't be allocated */
  /* Why would this pointer already be allocated anyhow? */
...
#ifdef TRILIBRARY
    out->numberofpoints = 0;           /* since the out->pointlist is going to be empty anyhow */
#endif
  } else {
...
#ifdef TRILIBRARY
    out->numberoftriangles = 0;           /* since the out->trianglelist is going to be empty anyhow */
#endif
  } else {
#ifdef TRILIBRARY
...
#ifdef TRILIBRARY
      out->numberofsegments = 0;           /* since the out->segmentlist is going to be empty anyhow */
#endif /* TRILIBRARY */
    } else {
#ifdef TRILIBRARY
...
#ifdef TRILIBRARY
    out->numberofedges = 0;           /* since the out->edgelist is going to be empty anyhow */
#endif /* TRILIBRARY */
  }
  if (b.voronoi) {
#ifdef TRILIBRARY
...
#ifdef TRILIBRARY
    /* In case vorout is not NULL but no voronoi output is desired */
    if (vorout != (struct triangulateio *) NULL) {
